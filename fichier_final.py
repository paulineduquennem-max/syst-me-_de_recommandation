...
@st.cache_data
def load_data():
    df_film = pd.read_csv(r"C:\Users\pauli\Documents\WCS\Projet_2-recommandation_de_film\Projet_2_final\Projet_2\df_FINAL_movie.csv")
    df_ml = pd.read_csv(r"C:\Users\pauli\Documents\WCS\Projet_2-recommandation_de_film\Projet_2_final\Projet_2\df_ML.csv")
    df_inter = pd.read_csv(r"C:\Users\pauli\Documents\WCS\Projet_2-recommandation_de_film\Projet_2_final\Projet_2\df_FINAL_intervenant.csv")
...
# --- CSS & FOND RECADRÉ ---
def apply_style():
    path_fond = r"C:\Users\pauli\Documents\WCS\Projet_2-recommandation_de_film\Projet_2_final\Projet_2\Gemini_Generated_Image_fond.png"
    try:
